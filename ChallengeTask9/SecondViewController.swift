...
class SecondViewController: UIViewController {
    ...
    @IBAction private func selectTokyo(_ sender: AnyObject) {
        selectPlace(placeName: "東京", sender: sender)
    }

    @IBAction private func selectKanagawa(_ sender: AnyObject) {
        selectPlace(placeName: "神奈川", sender: sender)
    }
    
    @IBAction private func selectSaitama(_ sender: AnyObject) {
        selectPlace(placeName: "埼玉", sender: sender)
    }

    @IBAction private func selectChiba(_ sender: AnyObject) {
